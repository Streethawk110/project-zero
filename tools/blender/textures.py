...
def mat_dirt(g):
    ...
    col = g.ramp(g.add(g.mul(clumps, 0.6), g.mul(big, 0.4)), [(0.0, "#4a3b2b"), (0.4, "#6a5641"), (0.75, "#836d52"), (1.0, "#9a8464")])
    col = g.mixc(col, g.ramp(crumbs, [(0.0, "#3a2e22"), (1.0, "#a8927a")]), 0.34, "OVERLAY")
