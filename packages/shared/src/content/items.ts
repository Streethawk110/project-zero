...
export const ITEMS: Record<string, ItemDef> = Object.fromEntries(
  (
    [
      ...
      { id: 'lockpick', name: 'Dietrich', cat: 'material', rarity: 'common', desc: 'Ein gebogener Eisenhaken. Öffnet Schlösser – wenn man das Gefühl dafür hat. Bricht leicht.', value: 12, stack: 20 },
      { id: 'bread', name: 'Roggenbrot', cat: 'consumable', rarity: 'common', desc: 'Macht satt (+30) und regeneriert 30 s lang Leben.', value: 4, stack: 20, use: { status: 'regen', statusDur: 30, cooldown: 2, food: 30 } },
      { id: 'apple', name: 'Apfel', cat: 'consumable', rarity: 'common', desc: 'Ein kleiner Happen (+12 Sättigung).', value: 1, stack: 30, use: { cooldown: 1, food: 12, stamina: 10 } },
      { id: 'cheese', name: 'Ziegenkäse', cat: 'consumable', rarity: 'common', desc: 'Würzig und sättigend (+25).', value: 5, stack: 20, use: { cooldown: 2, food: 25 } },
      { id: 'smoked_fish', name: 'Räucherfisch', cat: 'consumable', rarity: 'common', desc: 'Salzig, hält lange vor (+40 Sättigung).', value: 7, stack: 20, use: { cooldown: 2, food: 40, heal: 10 } },
